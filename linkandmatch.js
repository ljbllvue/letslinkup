...
// Function to update hidden form fields before submission
function updateHiddenFields() {
    // Update single-select hidden fields
    document.getElementById('gender-hidden').value = selectedValues.gender || '';
    document.getElementById('city-hidden').value = selectedValues.city || '';
    document.getElementById('platform-hidden').value = selectedValues.platform || '';
    
    // Update multi-select hidden fields (join arrays with commas)
    document.getElementById('category-hidden').value = selectedValues.category.join(', ');
    document.getElementById('aesthetic-hidden').value = selectedValues.aesthetic.join(', ');
    document.getElementById('contentType-hidden').value = selectedValues.contentType.join(', ');
    document.getElementById('lookingFor-hidden').value = selectedValues.lookingFor.join(', ');
    document.getElementById('experienceLevel-hidden').value = selectedValues.experienceLevel.join(', ');
}
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Handle form submission - update hidden fields before submitting
    const profileForm = document.getElementById('profile-form');
    if (profileForm) {
        profileForm.addEventListener('submit', function(e) {
            console.log('Form submission triggered');
            updateHiddenFields();
            console.log('Hidden fields updated, form will now submit to Netlify');
        });
    }
