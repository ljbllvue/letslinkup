...
// FIXED: Checkbox to String Conversion Functions
function updateInterestPlatforms() {
    ...
    document.getElementById('yourPlatformsHidden').value = selected.join(', ');
    console.log('Interest platforms updated:', selected.join(', '));
}

function updateShootPlatforms() {
    const checkboxes = document.querySelectorAll('#shootShotForm .platform-checkbox:checked');
    const selected = Array.from(checkboxes).map(cb => cb.value);
    document.getElementById('shootPlatformsHidden').value = selected.join(', ');
    console.log('Shoot platforms updated:', selected.join(', '));
}

function updateShootLookingFor() {
    const checkboxes = document.querySelectorAll('#shootShotForm input[id^="shoot-looking-"]:checked');
    const selected = Array.from(checkboxes).map(cb => cb.value);
    document.getElementById('shootLookingForHidden').value = selected.join(', ');
    console.log('Shoot looking for updated:', selected.join(', '));
}

function updateShootSceneType() {
    const checkboxes = document.querySelectorAll('#shootShotForm input[id^="shoot-scene-"]:checked');
    const selected = Array.from(checkboxes).map(cb => cb.value);
    document.getElementById('shootSceneTypeHidden').value = selected.join(', ');
    console.log('Shoot scene type updated:', selected.join(', '));
}

function updateShootNiche() {
    const checkboxes = document.querySelectorAll('#shootShotForm input[id^="shoot-niche-"]:checked');
    const selected = Array.from(checkboxes).map(cb => cb.value);
    document.getElementById('shootNicheHidden').value = selected.join(', ');
    console.log('Shoot niche updated:', selected.join(', '));
}

function updateShootHosting() {
    const checkboxes = document.querySelectorAll('#shootShotForm input[id^="shoot-hosting-"]:checked');
    const selected = Array.from(checkboxes).map(cb => cb.value);
    document.getElementById('shootHostingHidden').value = selected.join(', ');
    console.log('Shoot hosting updated:', selected.join(', '));
}
...
function closeModal() {
    ...
    // Clear hidden platform field
    document.getElementById('yourPlatformsHidden').value = '';
}
...
function closeShootShotModal() {
    ...
    document.getElementById('shootPlatformsHidden').value = '';
    document.getElementById('shootLookingForHidden').value = '';
    document.getElementById('shootSceneTypeHidden').value = '';
    document.getElementById('shootNicheHidden').value = '';
    document.getElementById('shootHostingHidden').value = '';
}
...
function initializePage() {
    ...
    // FIXED: Add event listeners for checkbox updates
